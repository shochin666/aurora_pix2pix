...
from cdf_handler import CdfHandler
from fits_handler import FitsHandler
from save_data import save_as_cdf, save_as_fits
from show_data import show_fullimg, show_img
from integrate import integrate_cdf_and_fits
...
sys.path.append(
    "/Users/ogawa/Desktop/desktop_folders/data_organize/pix2pix/aurora_pix2pix.py"
)
...
def main():
    ...
    # aurora_pix2pix
    print(sys.path)
    # model = Aurora_pix2pix()
    # input_path = os.path.join(DATA_DIRECTORY, "out/test/A")
